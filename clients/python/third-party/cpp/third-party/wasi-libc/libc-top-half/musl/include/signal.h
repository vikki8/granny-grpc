...
#if defined(__faasm) || defined(__wasilibc_unmodified_upstream) /* WASI has no ucontext support */
#ifdef _GNU_SOURCE
...
// Faasm: we need pthread_sigmask to cross-compile TensorFlow
#if defined(__faasm) ||  defined(__wasilibc_unmodified_upstream) /* WASI has no threads yet */
...
#if defined(__faasm) || defined(__wasilibc_unmodified_upstream) /* 1 is a valid function pointer on wasm */
