...
/* L100: */
		...
		for (l = 1; l <= *k; ++l) {
			...
			i__3 = j + l * a_dim1;
			q__2.r = alpha->r * A(j,l).r - alpha->i * A(j,l).i, 
				q__2.i = alpha->r * A(j,l).i + alpha->i * A(j,l).r;
			r_cnjg(&q__1, &q__2);
...
/* L110: */
			...
			i__4 = j + j * c_dim1;
			i__5 = j + l * a_dim1;
			q__2.r = A(j,l).r * temp1.r - A(j,l).i * temp1.i, 
				q__2.i = A(j,l).r * temp1.i + A(j,l).i * 
				temp1.r;
			i__6 = j + l * b_dim1;
			q__3.r = B(j,l).r * temp2.r - B(j,l).i * temp2.i, 
				q__3.i = B(j,l).r * temp2.i + B(j,l).i * 
				temp2.r;
...
/* L190: */
			...
			if (*beta == 0.f) {
			    ...
			    i__3 = i + j * c_dim1;
			    i__4 = i + j * c_dim1;
			    q__3.r = *beta * C(i,j).r, q__3.i = *beta * C(i,j).i;
