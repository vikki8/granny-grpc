...
/* Computing MIN */
			...
			i__3 = i;
			i__5 = k + i + j * a_dim1;
			z__2.r = temp.r * A(k+i,j).r - temp.i * A(k+i,j).i, 
				z__2.i = temp.r * A(k+i,j).i + temp.i * A(k+i,j)
				.r;
...
/* Computing MIN */
			...
			i__3 = k + i + j * a_dim1;
			i__4 = i;
			z__2.r = A(k+i,j).r * X(i).r - A(k+i,j).i * X(i)
				.i, z__2.i = A(k+i,j).r * X(i).i + A(k+i,j)
				.i * X(i).r;
...
/* Computing MIN */
			...
			i__4 = k + i + j * a_dim1;
			i__2 = ix;
			z__2.r = A(k+i,j).r * X(ix).r - A(k+i,j).i * X(ix)
				.i, z__2.i = A(k+i,j).r * X(ix).i + A(k+i,j)
				.i * X(ix).r;
			z__1.r = temp.r + z__2.r, z__1.i = temp.i + z__2.i;
			temp.r = z__1.r, temp.i = z__1.i;
			ix += *incx;
